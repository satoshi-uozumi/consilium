...
4. Mark tasks as complete in `<feature-name>/plan.md` as you go.
5. When all tasks are done, tell the user to run `/cs:done` for post-generate review and archival.