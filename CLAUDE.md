...
- Specialist consultation uses sub-agents — the sub-agent reads SKILL.md itself (local: Read tool; remote: get_skill MCP call); only the distilled result returns to main Claude; SKILL.md never enters the main context
